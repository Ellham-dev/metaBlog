        ...
        <div className="max-w-[1216px] mx-auto font-plusjakartasans">
          <div className="flex items-center justify-between py-16">
            ...
            <div className="bg-white w-[392px] flex flex-col items-center py-8 rounded-xl ">
              ...
              <input type="email" placeholder='Your Email' className='text-base leading-6 '/>
              <MdOutlineMail size={20}/>
              </div>
              <button className='py-3 w-[320px] text-base leading-6 font-medium bg-[#4B6BFB] rounded-xl text-white'>Subscribe</button>
            </div>
          </div>
        </div>
      </section>
